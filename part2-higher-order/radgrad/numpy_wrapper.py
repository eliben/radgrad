...
add_vjp_rule(_np.negative, lambda x: (-x, lambda g: [-g]))
add_vjp_rule(_np.sin, lambda x: (sin(x), lambda g: [cos(x) * g]))
add_vjp_rule(_np.cos, lambda x: (cos(x), lambda g: [-sin(x) * g]))
add_vjp_rule(_np.log, lambda x: (log(x), lambda g: [g / x]))
add_vjp_rule(_np.exp, lambda x: (exp(x), lambda g: [exp(x) * g]))
